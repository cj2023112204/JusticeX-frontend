...
const ButtonSheetScrollQuiz3 = ({ access_token }: any) => {
    ...
    const validateAnswer = (selectedOption: any) => {
        let correct_option = allQuestions[3][currentQuestionIndex]['correct_option'];
    ...
    const handleNext = () => {
        if (currentQuestionIndex == allQuestions[3].length - 1) {
            // Last Question
            // Show Score Modal
        ...
        return (
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{ color: COLORS.white, fontSize: 18, opacity: 0.6 }}>/ {allQuestions[3].length}</Text>
                </View>
                ...
                <Text style={{
                    color: COLORS.white,
                    fontSize: 30
                }}>{allQuestions[3][currentQuestionIndex]?.question}</Text>
            </View>
        )
    }
    const renderOptions = () => {
        return (
            <View>
                {
                    allQuestions[3][currentQuestionIndex]?.options.map(option => (
                        <TouchableOpacity
    ...
    const progressAnim = progress.interpolate({
        inputRange: [0, allQuestions[3].length],
        outputRange: ['0%', '100%']
    })
                ...
                >
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 30, fontWeight: 'bold' }}>{score > (allQuestions[3].length / 2) ? '快來留言吧!' : '快來留言吧!'}</Text>
...
export default ButtonSheetScrollQuiz3